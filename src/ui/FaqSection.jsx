      ...
      <div className="space-y-4">
        <Accordion open={open === 1}>
          <AccordionHeader
            ...
            className="flex flex-row-reverse justify-between items-center px-6 py-4  rounded-lg text-lg font-semibold text-gray-800 cursor-pointer hover:bg-gray-100 focus:outline-none border  transition-all duration-200">
            <ChevronDownIcon
          ...
          <AccordionBody className="px-6 py-4 text-gray-600 bg-white rounded-b-lg ">
